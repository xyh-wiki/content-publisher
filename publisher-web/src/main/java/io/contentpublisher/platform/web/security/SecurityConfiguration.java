    ...
    SecurityFilterChain jwtSecurityFilterChain(HttpSecurity http, SecurityProperties properties) throws Exception {
        ...
        return common(http)
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/articles/*/approve", "/api/v1/articles/*/reject").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/articles/*/publications").hasAnyRole("EDITOR", "ADMIN")
